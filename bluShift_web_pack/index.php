...
<html>
	<head>
		...
		<!--<script src="web/js/stickyNavBar.jquery.js"></script>-->
	</head>
	<body>
		<!---start-wrap----->
			<!---start-header----->
			...
			<div class="services">
				<div class="top-service-grids" id="services">
					<div class="top-service-grid">
						<a href="#"><img src=" web/images/blushift/softwareDevelopment.png" alt="" /></a>
						<a href="#"><span>General Software Development</span></a>
						<p>Is your business' software antiquated? Have no fear, bluShift is here!</p>
					</div>
					<div class="top-service-grid">
					...
					<div class="top-service-grid">
						<a href="#"><img src=" web/images/blushift/appDevelopment.png" alt="" /></a>
						<a href="#"><span>Mobile App Development</span></a>
						<p>We specialize in all your mobile development needs. Android and iOS; for personal or business.</p>
					</div>
					<div class="clear"> </div>
				</div>
			<!---End-top-grids---->
